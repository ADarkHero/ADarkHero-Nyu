    ...
    var j = {
        ...
        a = {
            ...
            Events: {
                ...
                onMouseUp: function () {
                    if (!a.widget_open && a.dragging_x) {
                        ...
                        a.dragging_x = 0;
                        var b = -1 * (a.widget_scroll_container.width() - a.window_width),
                            c = function () {
                                setTimeout(function () {
                                    a.widget_scroll_container.css("transition", "")
                                }, 400)
                            };
                        90 < a.left ? (a.widget_scroll_container.css("transition", "left 0.2s ease-in"), a.widget_scroll_container.css("left", 90), a.left = 90, c()) : a.left < b && (a.widget_scroll_container.css("transition", "left 0.2s ease-in"), a.widget_scroll_container.css("left", b), a.left = b, c())
                    }
                },
            ...
            openWidget: function (b) {
                var c = b.data("name"),
                    d = b.data("link");
                d && "" !== d ? window.open(d, "_blank") : $.trim(b.data("url")).length && (a.widget_open = b, window.location.hash = "#!/" + c, document.title = a.title_prefix + c, $("#widget_preview_content").remove(), a.widget_preview.addClass("open").css("background-color", b.css("background-color")).css("background-image", b.find(".main").css("background-image")), a.widget_scroll_container.hide(), a._loadWidget(b));
